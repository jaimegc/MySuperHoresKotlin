...
internal class SuperHeroesAdapter(
    ...
    fun addAll(collection: Collection<SuperHero>) = superHeroes.addAll(collection)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SuperHeroViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.super_hero_row, parent,false)
