...
import com.kotlin.mysuperheroeskotlin.ui.view.adapter.SuperHeroViewHolder
...
class SuperHeroViewHolderTest : ScreenshotTest {
    ...
    private fun givenASuperHeroWithALongDescription(): SuperHero {
        ...
        val isAvenger = false
        return givenASuperHero(superHeroName = superHeroName, superHeroDescription =
        superHeroDescription, isAvenger = isAvenger)
    }
    ...
    private fun givenASuperHero(
            ...
            isAvenger: Boolean = false): SuperHero = SuperHero(id, superHeroName, null, isAvenger,
